\abstractpage{
  This thesis presents a lightweight web application to serve \acrfull{gec} systems (from now on refers as GecWeb) so that they can be easily used by the general public.
